...
<body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
    ...
    <nav class="header-navbar navbar navbar-with-menu navbar-fixed-top navbar-semi-dark navbar-shadow">
        ...
        <div class="navbar-header">
            ...
            <li class="nav-item"><a href="/dashboard" class="navbar-brand nav-link"><img alt="branding logo" src="../../app-assets/images/logo/robust-logo-light.png" data-expand="../../app-assets/images/logo/robust-logo-light.png" data-collapse="../../app-assets/images/logo/robust-logo-small.png" class="brand-logo"></a></li>
        ...
        <div class="navbar-container content container-fluid">
            ...
            <ul class="nav navbar-nav float-xs-right">
                ...
                <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="../../app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">Dulanjan Madusanka</span></a>
    ...
    <div class="main-menu-content">
        ...
        <li><a href="/dashboard"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span><!-- <span class="tag tag tag-primary tag-pill float-xs-right mr-2">2</span> --></a>
        ...
        <li class=" nav-item"><a href="/tea-Inventory"><i class="icon-stack-2"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Tea Inventory</span></a>
            <ul class="menu-content">
            <li><a href="/tea-Inventory" data-i18n="nav.page_layouts.1_column" class="menu-item">Buyers Account Enter</a>
            </li>
            <li><a href="/tea-Blend" data-i18n="nav.page_layouts.2_columns" class="menu-item">Tea Blending Unit</a>
            </li>
            <li><a href="layout-boxed.html" data-i18n="nav.page_layouts.boxed_layout" class="menu-item">None Manufactured Tea Stock</a>
            </li>
            <li><a href="layout-static.html" data-i18n="nav.page_layouts.static_layout" class="menu-item">Finished Good Stock</a>
            </li>
            <li class="navigation-divider"></li>
            <li><a href="layout-light.html" data-i18n="nav.page_layouts.light_layout" class="menu-item">Raw Material Stock</a>
            </li>
        ...
        <li class=" nav-item"><a href="/po-master"><i class="icon-briefcase4"></i><span data-i18n="nav.project.main" class="menu-title">Create PO (Purchase Order)</span></a>
            <ul class="menu-content">
    ...
    @section('content')
     ...
     <footer class="footer footer-static footer-light navbar-border">
      <p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2020 <a href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank" class="text-bold-800 grey darken-2">OrangeHill </a>, All rights reserved. </p>
    </footer>
    ...
    <script src="../../app-assets/vendors/js/select2/js/select2.full.min.js" type="text/javascript"></script>
    <!-- BEGIN VENDOR JS-->
